...
class _$_Video implements _Video {
  ...
  @override
  String toString() {
    return 'Video(langCode: $langCode, countryCode: $countryCode, name: $name, key: $key, site: $site, size: $size, type: $type, official: $official, publishedAt: $publishedAt, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, langCode, countryCode, name, key,
